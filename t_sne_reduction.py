...
embedding = TSNE(n_components=2, perplexity=30, learning_rate='auto', init="pca", n_jobs=-1)
X_tsne = embedding.fit_transform(X_norm)
...
print(f"Zapisano t-SNE embedding i obrazy w: {RESULTS_DIR.resolve()}")
